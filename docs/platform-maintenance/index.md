...
請先確認你要處理的是 AI Hub WebUI 平台本身。這個封存頁用來支援平台維護者判斷功能域、查證正式環境證據，並找到下一個應查看的維運頁面。
...
| 狀況 | 下一步 |
| --- | --- |
| 不知道要從哪一區開始 | 先讀 [平台基礎](foundation/index.md)。 |
| 不確定是登入權限、發布憑證還是部署啟用金鑰 | 先讀 [模型憑證與授權](model-credentials-authorization/index.md)。 |
